...
class TestDictaBERTLoader:
    def setup_method(self, _method: object) -> None:
        ...
        _stub_transformers.AutoModel.from_pretrained.reset_mock()
    ...
    def test_us_01_ac_01_loader_is_lru_cached(self) -> None:
        ...
        _stub_transformers.AutoModel.from_pretrained.return_value = sentinel_model
        ...
        assert _stub_transformers.AutoModel.from_pretrained.call_count == 1
    ...
    def test_us_01_ac_01_loader_lazy_first_call(self) -> None:
        _stub_transformers.AutoModel.from_pretrained.assert_not_called()
        loader.load_model()
        assert _stub_transformers.AutoModel.from_pretrained.call_count == 1
